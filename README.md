...
``` 
``` 
3. Showcase MBs picture with associated token ID in cards components (gallery type of presentation)
``` 
``` 
4. (optional) Nice styling of the overall page & different components
``` 
...
The Real hidden denza : concrete denza (Attributes.Architecture)  + any tram (Attributes.Car)  - No file found for any tram
...
Water Elements : Fish Bowl (Attributes.Interior) + Beach or Island Sea (Attributes.Background + Concrete Wave (Attributes.Architecture) - No file found for Item
